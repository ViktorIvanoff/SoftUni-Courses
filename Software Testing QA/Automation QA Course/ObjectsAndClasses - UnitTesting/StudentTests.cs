...
public class StudentTests
{
    ...
    public void SetUp()
    {
        // making new instance of the Student obj
        this._student = new();
    }
    ...
    {
        // Arrange
        string[] students = { "John Doe 25 Sofia", "Jane Smith 22 Varna", "Alice Johnson " +
 "20 Sofia" };
        string expected = $"John Doe is 25 years old.{Environment.NewLine}Alice Johnson is " +
            $"20 years old.";
 ...
 "20 Sofia" };
        ...
        // Act
        string result = _student.AddAndGetByCity(students, "Velingrad");
        // Assert
        Assert.That(result, Is.EqualTo(expected));
    }
