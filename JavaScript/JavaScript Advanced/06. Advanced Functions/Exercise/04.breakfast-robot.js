function solution() {
    ...
    function prepare(recipeAsStr, quantity) {
        ...
        quantity = Number(quantity);
            ...
            // {
            //     carbohydrate: 1,    a recipe 
            //     flavour: 2
            // },
            let recipe = Object.entries(recipies[recipeAsStr]);
            ...
            // if it is - cook and print success
    ...
    function manager(line) {
        // "restock flavour 50"
        let [command, arg1, quantity] = line.split(' ');
        return commandProcessor[command](arg1, quantity);
    }
}
